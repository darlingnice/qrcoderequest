...
SECRET_KEY = 'django-insecure-b(lv!)m(nvp*b0@=-cpzh_&+56h*-@!sf#9mk^0+a$y%cg$vk#'
...
EMAIL_HOST_PASSWORD = 'nbyfxpqnlkaapuvu'
...
CELERY_TASK_RETRY_POLICY = {
    ...
    'interval_start': 0,     # First retry after 0 seconds
    'interval_step': 2,      # Exponential backoff step
    'interval_max': 10,      # Max wait time between retries
}
